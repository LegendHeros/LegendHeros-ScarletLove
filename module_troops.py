...
#  n |= wp_throwing(x + random.randrange(r))
  n |= wp_one_handed(x * 3 / 2)      #HS *3/2 所有熟练度 乘以1.5 
  n |= wp_two_handed(x * 3 / 2)
  n |= wp_polearm(x * 3 / 2)
  n |= wp_archery(x * 3 / 2)
  n |= wp_crossbow(x * 3 / 2)
  n |= wp_throwing(x * 3 / 2)
...
def wpe(m,a,c,t):
   n = 0
   n |= wp_one_handed(m * 3 / 2)
   n |= wp_two_handed(m * 3 / 2)
   n |= wp_polearm(m * 3 / 2)
   n |= wp_archery(a * 3 / 2)
   n |= wp_crossbow(c * 3 / 2)
   n |= wp_throwing(t * 3 / 2)
...
def wpex(o,w,p,a,c,t):
   n = 0
   n |= wp_one_handed(o * 3 / 2)
   n |= wp_two_handed(w * 3 / 2)
   n |= wp_polearm(p * 3 / 2)
   n |= wp_archery(a * 3 / 2)
   n |= wp_crossbow(c * 3 / 2)
   n |= wp_throwing(t * 3 / 2)   
...
#  n |= wp_two_handed(x + random.randrange(r))
#  n |= wp_polearm(x + random.randrange(r))
  n |= wp_one_handed(x * 3 / 2 + 20)
  n |= wp_two_handed(x * 3 / 2)
  n |= wp_polearm(x * 3 / 2 + 10)
  return n    #HS *3/2 所有熟练度 乘以1.5 
  
 # wp_one_handed (90) | wp_two_handed (90) | wp_polearm (90) | wp_archery (90) | wp_crossbow (130) | wp_throwing (90)

def wp_one_handed(x):
   n = 0
   n |= wp_one_handed(x * 3 / 2)
...
def_attrib = str_7 | agi_5 | int_5 | cha_3
...
#peasant - retainer - footman - man-at-arms -  knight
  ...
  #斯 瓦 迪 亚 军 士 精英 等级+10 铁骨加3 跑动+1 强击+2
  ["swadian_sergeant2","Swadian Sergeant","Swadian Sergeants",tf_mounted|tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_1,
   [itm_awlpike,itm_bastard_sword_b,itm_morningstar,itm_sword_medieval_c,itm_tab_shield_heater_d,
    itm_coat_of_plates,itm_brigandine_red,itm_mail_boots,itm_iron_greaves,itm_flat_topped_helmet,itm_guard_helmet,itm_mail_mittens,itm_gauntlets],
   def_attrib|level(35),wp_melee(135*3/2),knows_common|knows_shield_4|knows_ironflesh_7|knows_power_strike_6|knows_athletics_5,swadian_face_middle_1, swadian_face_older_2],
  ...
  ["swadian_crossbowman","Swadian Crossbowman","Swadian Crossbowmen",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_kingdom_1,
   ...
   ##斯 瓦 迪 亚 狙 击 手精英 等级+10 铁骨加2 跑动+2 强击+2
   ["swadian_sharpshooter2","Swadian Sharpshooter","Swadian Sharpshooters",tf_guarantee_ranged|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_1,
   [itm_bolts,itm_arrows,itm_crossbow,itm_crossbow,itm_heavy_crossbow,itm_sword_medieval_b_small,itm_sword_medieval_a,itm_voulge,itm_tab_shield_heater_c,
    itm_haubergeon,itm_arena_armor_red,itm_leather_boots,itm_mail_chausses,itm_kettle_hat,itm_helmet_with_neckguard,itm_leather_gloves],
   str_14 | agi_10 | int_4 | cha_4|level(34),wp_one_handed (100*3/2) | wp_two_handed (100*3/2) | wp_polearm (100*3/2) | wp_archery (100*3/2) | wp_crossbow (120*3/2) | wp_throwing (100*3/2),knows_common|knows_power_draw_3|knows_ironflesh_3|knows_power_strike_3|knows_athletics_4,swadian_face_middle_1, swadian_face_older_2],
 ...
 #斯 瓦 迪 亚 骑 士 精英 等级+10 熟练度+2分之一，骑术=1 强击=2 铁骨=3
  ["swadian_knight2","Swadian Knight","Swadian Knights",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_1,
   [itm_heavy_lance,itm_sword_two_handed_b,itm_sword_medieval_d_long,itm_morningstar,itm_morningstar,itm_sword_medieval_d_long,itm_tab_shield_heater_cav_b,
    itm_coat_of_plates_red,itm_cuir_bouilli,itm_plate_boots,itm_guard_helmet,itm_great_helmet,itm_bascinet,itm_charger,itm_warhorse,itm_gauntlets,itm_mail_mittens],
   def_attrib|level(38),wp_one_handed (150*3/2) | wp_two_handed (130*3/2) | wp_polearm (130*3/2) | wp_archery (750*3/2) | wp_crossbow (75*3/2) | wp_throwing (75*3/2),knows_common|knows_riding_6|knows_shield_5|knows_ironflesh_8|knows_power_strike_7,swadian_face_middle_1, swadian_face_older_2],
...
# Vaegir watchman?
  ...
  ["vaegir_archer","Vaegir Archer","Vaegir Archers",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_kingdom_2,
   ...
   ###维 基 亚 神 射 手 精英
   ["vaegir_marksman2","Vaegir Marksman","Vaegir Marksmen",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_2,
   [itm_barbed_arrows,itm_axe,itm_voulge,itm_sword_khergit_2,itm_strong_bow,itm_war_bow,itm_strong_bow,
    itm_leather_vest,itm_studded_leather_coat,itm_leather_boots,itm_vaegir_lamellar_helmet,itm_vaegir_spiked_helmet,itm_vaegir_fur_helmet],
   str_14 | agi_5 | int_4 | cha_4|level(34),wp_one_handed (80*3/2) | wp_two_handed (80*3/2) | wp_polearm (80*3/2) | wp_archery (140*3/2) | wp_crossbow (80*3/2) | wp_throwing (80*3/2),knows_ironflesh_3|knows_power_draw_8|knows_athletics_4|knows_power_throw_1,vaegir_face_young_1, vaegir_face_older_2],
...
###维 基 亚 卫 士精英
   ["vaegir_guard2","Vaegir Guard","Vaegir Guards",tf_mounted|tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_2,
   [itm_ashwood_pike,itm_fighting_axe,itm_bardiche,itm_battle_axe,itm_fighting_axe,itm_tab_shield_kite_d,
    itm_banded_armor,itm_lamellar_vest,itm_lamellar_armor,itm_mail_chausses,itm_iron_greaves,itm_vaegir_war_helmet,itm_vaegir_war_helmet,itm_vaegir_lamellar_helmet,itm_leather_gloves],
   def_attrib|level(34),wp_melee(130*3/2),knows_riding_2|knows_athletics_5|knows_shield_2|knows_ironflesh_6|knows_power_strike_6,vaegir_face_middle_1, vaegir_face_older_2],
 ...
 ###维 基 亚 骑 士精英
 ["vaegir_knight2","Vaegir Knight","Vaegir Knights",tf_mounted|tf_guarantee_boots|tf_guarantee_gloves|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_2,
   [itm_bardiche,itm_great_bardiche,itm_war_axe,itm_fighting_axe,itm_lance,itm_lance,itm_tab_shield_kite_cav_b,
    itm_banded_armor,itm_lamellar_vest,itm_lamellar_armor,itm_mail_boots,itm_plate_boots,itm_vaegir_war_helmet,itm_vaegir_war_helmet,itm_vaegir_lamellar_helmet,itm_hunter, itm_warhorse_steppe,itm_leather_gloves],
   def_attrib|level(36),wp_one_handed (120*3/2) | wp_two_handed (140*3/2) | wp_polearm (120*3/2) | wp_archery (120*3/2) | wp_crossbow (120*3/2) | wp_throwing (120*3/2),knows_riding_6|knows_shield_2|knows_ironflesh_7|knows_power_strike_6,vaegir_face_middle_1, vaegir_face_older_2],
...
#库 吉 特 资 深 骑 射 手　精英
   ["khergit_veteran_horse_archer2","Khergit Veteran Horse Archer","Khergit Veteran Horse Archers",tf_mounted|tf_guarantee_all,0,0,fac_kingdom_3,
   [itm_sword_khergit_3,itm_winged_mace,itm_spear,itm_khergit_bow,itm_khergit_bow,itm_khergit_bow
   ,itm_nomad_bow,itm_arrows,itm_khergit_arrows,itm_khergit_arrows,itm_khergit_arrows,itm_javelin,itm_tab_shield_small_round_b,itm_tab_shield_small_round_c,
    itm_khergit_cavalry_helmet,itm_khergit_cavalry_helmet,itm_leather_warrior_cap,itm_lamellar_vest_khergit,itm_tribal_warrior_outfit,itm_khergit_leather_boots,itm_leather_gloves,itm_steppe_horse,itm_courser],
   def_attrib|level(31),wp_one_handed (90*3/2) | wp_two_handed (90*3/2) | wp_polearm (90*3/2) | wp_archery (130*3/2) | wp_crossbow (90*3/2) | wp_throwing (130*3/2),knows_riding_8|knows_power_draw_7|knows_ironflesh_3|knows_horse_archery_9|knows_power_throw_4|knows_shield_1,khergit_face_middle_1, khergit_face_older_2],
...
#库 吉 特 枪 骑 兵精英
   ["khergit_lancer2","Khergit Lancer","Khergit Lancers",tf_mounted|tf_guarantee_all_wo_ranged,0,0,fac_kingdom_3,
   [itm_sword_khergit_4,itm_spiked_mace,itm_one_handed_war_axe_b,itm_hafted_blade_a,itm_hafted_blade_b,itm_heavy_lance,itm_lance,
    itm_khergit_guard_helmet,itm_khergit_cavalry_helmet,itm_khergit_war_helmet,itm_lamellar_vest_khergit,itm_lamellar_armor,itm_khergit_leather_boots,itm_splinted_leather_greaves,itm_leather_gloves,itm_scale_gauntlets,itm_tab_shield_small_round_b,itm_tab_shield_small_round_c,itm_courser,itm_warhorse_steppe,itm_warhorse_steppe,itm_warhorse_steppe],
   def_attrib|level(33),wp_one_handed (110*3/2) | wp_two_handed (110*3/2) | wp_polearm (150*3/2) | wp_archery (110*3/2) | wp_crossbow (110*3/2) | wp_throwing (110*3/2),knows_riding_8|knows_power_strike_7|knows_power_draw_4|knows_power_throw_2|knows_ironflesh_2|knows_horse_archery_1|knows_shield_2,khergit_face_middle_1, khergit_face_older_2],
...
##诺 德 皇 家 侍 卫 （ 精 英 
   ["nord_champion2","Nord Huscarl","Nord Huscarls",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield|tf_guarantee_helmet,0,0,fac_kingdom_4,
   [itm_sword_viking_3,itm_sword_viking_3_small,itm_great_axe,itm_one_handed_battle_axe_c,itm_tab_shield_round_e,itm_throwing_spears,itm_heavy_throwing_axes,itm_heavy_throwing_axes,
    itm_nordic_huscarl_helmet,itm_nordic_warlord_helmet,itm_banded_armor,itm_mail_boots,itm_mail_chausses,itm_mail_mittens],
   def_attrib|level(38),wp(170*3/2),knows_ironflesh_9|knows_power_strike_9|knows_power_throw_5|knows_riding_2|knows_athletics_9|knows_shield_6,nord_face_middle_1, nord_face_older_2],
...
##诺 德 资 深 弓 箭 手　
   ["nord_veteran_archer2","Nord Veteran Archer","Nord Veteran Archers",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_kingdom_4,
   [itm_bodkin_arrows,itm_sword_viking_2,itm_fighting_axe,itm_two_handed_axe,itm_long_bow,itm_mail_shirt,itm_mail_shirt,itm_byrnie,itm_leather_boots,itm_nordic_archer_helmet,itm_nordic_veteran_archer_helmet],
   str_12 | agi_5 | int_4 | cha_4|level(26),wp_one_handed (95*3/2) | wp_two_handed (95*3/2) | wp_polearm (95*3/2) | wp_archery (120*3/2) | wp_crossbow (95*3/2) | wp_throwing (95*3/2),knows_power_strike_3|knows_ironflesh_5|knows_power_draw_7|knows_athletics_8,nord_face_middle_1, nord_face_older_2],
...
##罗 多 克 军 士　
   ["rhodok_sergeant2","Rhodok Sergeant","Rhodok Sergeants",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_shield|tf_guarantee_gloves,0,0,fac_kingdom_5,
   [itm_glaive,itm_military_hammer,itm_military_cleaver_c,itm_tab_shield_pavise_d,
    itm_full_helm, itm_bascinet_3,itm_bascinet_2,itm_surcoat_over_mail,itm_surcoat_over_mail,itm_heraldic_mail_with_surcoat,itm_mail_chausses,itm_leather_gloves,itm_mail_mittens],
   def_attrib|level(35),wp_one_handed (130*3/2) | wp_two_handed (115*3/2) | wp_polearm (155*3/2) | wp_archery (115*3/2) | wp_crossbow (115*3/2) | wp_throwing (115*3/2),knows_common|knows_ironflesh_8|knows_shield_6|knows_power_strike_2|knows_athletics_5,rhodok_face_middle_1, rhodok_face_older_2],
 ...
 #罗 多 克 狙 击 弩 手　精英
 ["rhodok_sharpshooter2","Rhodok Sharpshooter","Rhodok Sharpshooters",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_ranged|tf_guarantee_shield,0,0,fac_kingdom_5,
   [itm_sword_medieval_b,itm_military_pick,itm_military_hammer,itm_tab_shield_pavise_c,itm_sniper_crossbow,itm_steel_bolts,
    itm_kettle_hat,itm_mail_coif,itm_mail_with_tunic_green,itm_leather_boots,itm_splinted_leather_greaves],
   str_14 | agi_5 | int_4 | cha_4|level(35),wp_one_handed (110*3/2) | wp_two_handed (110*3/2) | wp_polearm (110*3/2) | wp_archery (100*3/2) | wp_crossbow (140*3/2) | wp_throwing (100*3/2),knows_common|knows_ironflesh_5|knows_shield_5|knows_power_strike_5|knows_athletics_7,rhodok_face_middle_1, rhodok_face_older_2],
...
##萨 兰 德 卫 士精英
   ["sarranid_guard2","Sarranid Guard","Sarranid Guards",tf_mounted|tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_6,
   [itm_military_pick,itm_sarranid_two_handed_axe_a,itm_jarid,itm_scimitar_b,itm_war_spear,itm_mace_4,itm_sarranid_boots_d, itm_sarranid_boots_c,itm_arabian_armor_b,itm_sarranid_mail_coif,itm_sarranid_veiled_helmet,itm_mail_mittens,itm_leather_gloves,itm_tab_shield_kite_d],
   def_attrib|level(35),wp_one_handed (135*3/2) | wp_two_handed (135*3/2) | wp_polearm (135*3/2) | wp_archery (75*3/2) | wp_crossbow (75*3/2) | wp_throwing (140*3/2),knows_common|knows_shield_4|knows_ironflesh_5|knows_power_strike_6|knows_power_throw_4|knows_athletics_5,swadian_face_middle_1, swadian_face_older_2],
...
##萨 兰 德 弓 箭 大 师精英
   ["sarranid_master_archer2","Sarranid Master Archer","Sarranid Master Archers",tf_guarantee_ranged|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_6,
   [itm_barbed_arrows,itm_barbed_arrows,itm_arabian_sword_b,itm_mace_3,itm_strong_bow,itm_nomad_bow,
    itm_arabian_armor_b,itm_sarranid_boots_c,itm_sarranid_boots_b,itm_sarranid_mail_coif],
   str_14 | agi_5 | int_4 | cha_4|level(34),wp_one_handed (100*3/2) | wp_two_handed (100*3/2) | wp_polearm (100*3/2) | wp_archery (130*3/2) | wp_crossbow (100*3/2) | wp_throwing (130*3/2),knows_common|knows_power_draw_7|knows_power_throw_4|knows_ironflesh_3|knows_athletics_6,swadian_face_middle_1, swadian_face_older_2],
...
##萨 兰 德 马 穆 鲁 精英
   ["sarranid_mamluke2","Sarranid Mamluke","Sarranid Mamlukes",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_6,
   [itm_heavy_lance,itm_scimitar_b,itm_sarranid_two_handed_mace_1,itm_sarranid_cavalry_sword,itm_tab_shield_small_round_c,
    itm_mamluke_mail,itm_sarranid_boots_d,itm_sarranid_boots_c,itm_sarranid_veiled_helmet,itm_arabian_horse_b,itm_warhorse_sarranid,itm_scale_gauntlets,itm_mail_mittens],
   def_attrib|level(37),wp_one_handed (150*3/2) | wp_two_handed (130*3/2) | wp_polearm (130*3/2) | wp_archery (75*3/2) | wp_crossbow (75*3/2) | wp_throwing (110*3/2),knows_common|knows_riding_7|knows_shield_5|knows_ironflesh_2|knows_power_strike_7,swadian_face_middle_1, swadian_face_older_2],
...
#####女剑士精英（女中豪杰）
   ["sword_sister2","Sword Sister","Sword Sisters",tf_female|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_shield|tf_guarantee_horse,0,0,fac_commoners,
   [itm_bolts,itm_sword_medieval_b,itm_sword_khergit_3,itm_plate_covered_round_shield,itm_tab_shield_small_round_c, itm_crossbow,itm_plate_armor,itm_coat_of_plates,itm_plate_boots,itm_guard_helmet,itm_helmet_with_neckguard,itm_courser,itm_leather_gloves],
   def_attrib|level(32),wp(140*3/2),knows_common|knows_power_strike_5|knows_riding_5|knows_athletics_5|knows_ironflesh_4|knows_shield_2,refugee_face1,refugee_face2],
...
##农妇 增加武器 石头   
  ["peasant_woman","Peasant Woman","Peasant Women",tf_female|tf_guarantee_armor,0,0,fac_commoners,
   [itm_knife,itm_pitch_fork,itm_sickle,itm_hatchet,itm_club,itm_dress,itm_woolen_dress, itm_headcloth, itm_woolen_hood, itm_wrapping_boots,itm_stones],
...
upgrade(troops,"swadian_sergeant","swadian_sergeant2") #斯 瓦 迪 亚 军 士 （ 精 英 ）
upgrade(troops,"swadian_skirmisher","swadian_crossbowman")

upgrade(troops,"swadian_crossbowman","swadian_sharpshooter")
upgrade(troops,"swadian_sharpshooter","swadian_sharpshooter2")#斯 瓦 迪 亚 狙 击 手 （ 精 英 ） 　

upgrade(troops,"swadian_man_at_arms","swadian_knight")
upgrade(troops,"swadian_knight","swadian_knight2") #斯 瓦 迪 亚  骑 士 （ 精 英 ） 
...
upgrade(troops,"vaegir_archer","vaegir_marksman") #维 基 亚 神 射 手　（ 精 英 ） 
upgrade(troops,"vaegir_marksman","vaegir_marksman2") #维 基 亚 神 射 手　（ 精 英 ） 

upgrade2(troops,"vaegir_veteran","vaegir_horseman","vaegir_infantry")

upgrade(troops,"vaegir_infantry","vaegir_guard")
upgrade(troops,"vaegir_guard","vaegir_guard2")  #维 基 亚 卫 士　精英
upgrade(troops,"vaegir_horseman","vaegir_knight")
upgrade(troops,"vaegir_knight","vaegir_knight2") #维 基 亚 骑 士 （ 精 英 ）
...
upgrade(troops,"khergit_lancer","khergit_lancer2") #库 吉 特 枪 骑 兵　精英
upgrade(troops,"khergit_horse_archer","khergit_veteran_horse_archer")
upgrade(troops,"khergit_veteran_horse_archer","khergit_veteran_horse_archer2") #库 吉 特 资 深 骑 射 手 （ 精 英 ）　
...
upgrade(troops,"nord_champion","nord_champion2") #诺 德 皇 家 侍 卫 （ 精 英 ）　
upgrade(troops,"nord_huntsman","nord_archer")
upgrade(troops,"nord_archer","nord_veteran_archer")
upgrade(troops,"nord_veteran_archer","nord_veteran_archer2")#诺 德 资 深 弓 箭 手　精英
...
upgrade(troops,"rhodok_sergeant","rhodok_sergeant2")  #罗 多 克 军 士 （ 精 英 ）　
...
upgrade(troops,"rhodok_sharpshooter","rhodok_sharpshooter2")#罗 多 克 狙 击 弩 手　精英
...
upgrade(troops,"sarranid_master_archer","sarranid_master_archer2") #萨 兰 德 弓 箭 大 师　精英

upgrade(troops,"sarranid_horseman","sarranid_mamluke")
upgrade(troops,"sarranid_mamluke","sarranid_mamluke2") #萨 兰 德 马 穆 鲁 克　精英
